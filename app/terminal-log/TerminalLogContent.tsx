...
export default function TerminalLogContent() {
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-[#F3F3F3] selection:bg-[#836EF9] selection:text-black font-sans overflow-x-hidden relative">
      
      {/* READING PROGRESS BAR (Jurnal Element) */}
      <motion.div 
        className="fixed top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#836EF9] to-[#00FF9D] z-[100] origin-left" 
        style={{ scaleX }} 
      />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex items-center gap-3 text-[11px] font-mono tracking-widest text-[#836EF9] uppercase font-bold">
              ...
              <span className="text-neutral-500">// Archive 01</span>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <Calendar size={14} /> 14 Maret 2026
              </div>
              <div className="flex items-center gap-2">
      ...
      <article className="relative py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <motion.div 
            ...
            variants={stagger}
            className="space-y-10 text-[17px] md:text-[19px] text-neutral-300 leading-[1.8] font-light"
          >
            ...
            <motion.div variants={fadeUp} className="py-6">
              <figure className="relative aspect-[16/9] w-full rounded-sm overflow-hidden border border-white/10 group bg-white/5">
                <Image 
                  ...
                  alt="Ilustrasi Phygital Fashion Jakarta" 
                  fill 
                  className="object-cover group-hover:scale-105 transition-transform duration-1000" 
                />
                <figcaption className="absolute bottom-4 left-4 bg-black/80 backdrop-blur-md px-3 py-1.5 text-[10px] font-mono text-neutral-300 border border-white/10 uppercase tracking-widest">
            ...
            <motion.div variants={fadeUp} className="space-y-5">
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight pt-4">
                1. Apa Itu Phygital Fashion dan Kenapa Butuh Ini Sekarang
              </h2>
              <p>
            ...
            <motion.div variants={fadeUp} className="space-y-5">
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight pt-8 border-t border-white/5 mt-8">
                2. Cara Kerja: Dari Produk Fisik ke NFT dalam 3 Langkah
              </h2>
              <p>
            ...
            <motion.div variants={fadeUp} className="space-y-5">
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight pt-8 border-t border-white/5 mt-8">
                3. Koleksi 0xTanda yang Tersedia Sekarang di Websitenya
              </h2>
              <p>
              ...
              <div className="bg-[#121212] border border-white/10 p-6 md:p-8 rounded-sm space-y-4">
                <p>
                  <span className="text-[#00FF9D] font-bold">16s Heavyweight Cotton:</span> Menggunakan material kapas murni seberat ±245 GSM yang sangat tebal, memberikan struktur kaku yang konsisten dan daya tahan bertahun-tahun (Anti-Fast Fashion).
                </p>
                <div className="w-full h-[1px] bg-white/5" />
                <p>
                  <span className="text-[#00FF9D] font-bold">Boxy Oversized Silhouette:</span> Potongan arsitektural yang dirancang untuk memberikan volume dan pernyataan gaya yang kuat di jalanan.
                </p>
                <div className="w-full h-[1px] bg-white/5" />
                <p>
                  <span className="text-[#00FF9D] font-bold">High-Density Art Print:</span> Desain Cyborg Archetype yang melambangkan fusi manusia dan teknologi, dicetak dengan presisi tinggi untuk ketahanan cuci maksimal.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="space-y-6">
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight pt-8 border-t border-white/5 mt-8">
                4. Kenapa Pembeli Memilih 0xTanda vs Brand Fashion Biasa
              </h2>
              <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                ...
                <div className="bg-[#836EF9]/5 border border-[#836EF9]/30 p-6 md:p-8 rounded-sm space-y-4 relative overflow-hidden">
                  ...
                  <p className="text-[11px] text-neutral-400 font-mono uppercase tracking-widest font-bold">
                    (200 Pembeli Pertama)
                  </p>
                ...
                {/* KOTAK B */}
                <div className="bg-white/5 border border-white/10 p-6 md:p-8 rounded-sm space-y-4 relative overflow-hidden">
                  <h3 className="text-white font-bold text-lg md:text-xl tracking-tight">B. REGULAR HOLDER</h3>
                  <p className="text-[11px] text-neutral-500 font-mono uppercase tracking-widest font-bold">
                    (Verified Owners)
                  </p>
            ...
            <motion.div variants={fadeUp} className="space-y-5">
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight pt-8 border-t border-white/5 mt-8">
                5. Cara Beli dan Klaim NFT-mu Hari Ini (Tanpa Harus Ahli Crypto)
              </h2>
              <p>
                Kami percaya bahwa teknologi seharusnya mempermudah, bukan mempersulit. Di 0xTanda, akses ke masa depan fashion dibuat semudah belanja daring biasa.
              </p>
