...
export default function VerifyFormPage() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === 'secretCode') {
      ...
      // 2. Batasi maksimal 12 karakter (nanti ditambah 2 strip jadi total 14)
      ...
      <div className="pt-32 px-6 pb-20 max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-[#121212] border border-white/10 p-8 rounded-sm mb-12 relative overflow-hidden group">
          ...
          <ul className="space-y-3 text-[10px] md:text-xs text-neutral-400 uppercase tracking-wide leading-relaxed relative z-10">
            ...
            <li className="flex gap-3"><span className="text-[#836EF9] font-bold">02.</span> PASTIKAN alamat wallet yang dimasukkan adalah Personal Wallet MONAD (Metamask/Phantom/Hot Wallet lainnya).</li>
            <li className="flex gap-3 text-red-500 font-bold bg-red-900/10 p-2 border border-red-900/30 rounded"><span className="text-red-500">03.</span> 🚫 DILARANG menggunakan alamat Exchange (Indodax/Binance/Tokocrypto/Bybit. dll).</li>
            ...
            <div className="bg-gradient-to-b from-[#1a1a1a] to-black border border-[#836EF9]/50 p-8 rounded-sm shadow-[0_0_30px_rgba(131,110,249,0.1)] relative overflow-hidden">
              ...
              <div className="grid gap-10">
                ...
                <div className="space-y-3 relative z-10">
                  ...
                  />
                  <p className="text-[9px] text-neutral-500 uppercase tracking-widest text-center">*Strip (-) akan ditambahkan secara otomatis</p>
                </div>
